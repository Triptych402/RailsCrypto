...
class BitcoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bitcoin" do
    assert_difference('Bitcoin.count') do
      post bitcoins_url, params: { bitcoin: { amount_owned: @bitcoin.amount_owned, cost_per: @bitcoin.cost_per, symbol: @bitcoin.symbol, user_id: @bitcoin.user_id } }
    end
  ...
  test "should update bitcoin" do
    patch bitcoin_url(@bitcoin), params: { bitcoin: { amount_owned: @bitcoin.amount_owned, cost_per: @bitcoin.cost_per, symbol: @bitcoin.symbol, user_id: @bitcoin.user_id } }
